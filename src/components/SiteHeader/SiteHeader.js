...
export default function SiteHeader({ storedUser, boardRef, onWaClick }) {
  ...
  return (
    <div className={styles.siteHeader}>
      <img src="/assets/main-house.png" alt={he.siteLogoAlt} className={styles.siteLogo} />
      {storedUser?.mainHouse && (
        <button className={styles.scrollToHouseBtn} title={he.siteScrollToMyHouse} onClick={handleScrollToHouse}>
          🎯
        </button>
      )}
      <a
