    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <p>משתמשים רשאים לפרסם פרסומות בתשלום של 100 מטבעות ל-5 ימים. הפרסום חייב לעמוד בכללי ההתנהגות הנ"ל. מפעילי האתר שומרים לעצמם את הזכות להסיר כל פרסומת שנמצאת בניגוד לתקנון.</p>
        </section>
