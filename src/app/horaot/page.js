    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <p>כל שעה עגולה החווה מייצרת ביצה 🥚. לחצו על החווה שלכם כדי לאסוף את הביצה ולקבל 20 🪙.</p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li>איסוף ביצה מהחווה 🥚 - 20 🪙 לשעה.</li>
            <li>בונוס שכונה יומי 🎁 - 50 🪙 פעם ביום לכל שכונה שאתם חלק ממנה.</li>
          </ul>
        </section>
